...
const routes: Routes = [
  ...
  {
    path: 'foodmenu',
    loadChildren: () => import('./pages/foodmenu/foodmenu.module').then( m => m.FoodmenuPageModule)
  },
  {
    path: 'foodmenudetails',
    loadChildren: () => import('./pages/foodmenudetails/foodmenudetails.module').then( m => m.FoodmenudetailsPageModule)
  },
  {
    path: 'notification',
